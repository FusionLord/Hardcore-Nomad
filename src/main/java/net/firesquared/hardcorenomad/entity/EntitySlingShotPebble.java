...
public class EntitySlingShotPebble extends Entity implements IProjectile
{
	...
	public static DamageSource causePebbleDamage(EntitySlingShotPebble par0EntityPebble, Entity par1Entity)
	{
		return (new EntityDamageSourceIndirect("pebble", par0EntityPebble, par1Entity)).setProjectile();
	}
}
