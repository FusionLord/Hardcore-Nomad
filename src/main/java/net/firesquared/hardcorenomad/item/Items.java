...
public enum Items
{
	...
	//Upgrade Items
	//Bedroll Upgrades
	ITEM_UPGRADE_BEDROLL_TIER1("upgrade.bedroll.tier1", new itemUpgradeTier1BedRoll(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 3),
	ITEM_UPGRADE_BEDROLL_TIER2("upgrade.bedroll.tier2", new itemUpgradeTier2BedRoll(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 1),
	...
	//Camp Fire Upgrades
	ITEM_UPGRADE_CAMPFIRE_TIER1("upgrade.campfire.tier1", new itemUpgradeTier1CampFire(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 3),
	ITEM_UPGRADE_CAMPFIRE_TIER2("upgrade.campfire.tier2", new itemUpgradeTier2CampFire(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 1),
	...
	ITEM_UPGRADE_ENCHANTTABLE_TIER1("upgrade.enchanttable.tier1", new itemUpgradeTier1BedRoll(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 3),
	ITEM_UPGRADE_ENCHANTTABLE_TIER2("upgrade.enchanttable.tier2", new itemUpgradeTier2BedRoll(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 2),
	ITEM_UPGRADE_ENCHANTTABLE_TIER3("upgrade.enchanttable.tier3", new itemUpgradeTier3BedRoll(), CreativeTab.HardCoreNomadUpgradesTab, 1, 1, 1),
