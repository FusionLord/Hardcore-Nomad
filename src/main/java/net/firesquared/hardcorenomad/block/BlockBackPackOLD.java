...
public class BlockBackPackOLD extends BlockContainer
{
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int p_149749_6_)
	{
		...
		TileEntityBackPackOLD tileEntityBackPack = TileEntityHelper.getTileEntity(world, x, y, z, TileEntityBackPackOLD.class);
		...
		switch(BackPackType.values()[backPackType])
		{
//			case BACKPACK_BASIC:
...
//		itemStack.setTagCompound(nbtTagCompound);
	...
	{
		return TileEntityBackPackOLD.ModelID;
	}
