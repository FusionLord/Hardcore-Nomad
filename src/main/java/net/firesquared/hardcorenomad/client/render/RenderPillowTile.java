...
public class RenderPillowTile extends TileEntitySpecialRenderer
{
	public static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("hardcorenomad:models/bed/pillow.obj"));

	public static final ResourceLocation texture = new ResourceLocation("hardcorenomad:models/bed/pillow.png");
