package net.firesquared.firesquaredcore.helper;
...
public class Helper
{
	...
	{
		private static final String MOD_ID = "firesquaredlib";
		private static final String MOD_NAME = "FireSquared Library";
		private static final String VERSION_NUMBER = "0.0.2";
		private static final String CHANNEL_NAME = MOD_ID;
	}
