...
import net.firesquared.firesquaredcore.client.gui.elements.SimpleDrawingElement;
import net.firesquared.firesquaredcore.client.gui.helper.TexturedQuadDrawer;
import net.firesquared.firesquaredcore.client.gui.helper.IQuadDrawer;
