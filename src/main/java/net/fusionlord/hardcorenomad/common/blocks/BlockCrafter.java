...
import net.fusionlord.hardcorenomad.common.tileentity.TileEntityCrafter;
...
public class BlockCrafter extends BlockUpgradable
{
	public BlockCrafter()
	{
		super(Material.wood, EnumUpgrade.STONE);
		setRegistryName(ModInfo.ID, "crafter");
	...
	{
		return TileEntityCrafter.class;
	}
